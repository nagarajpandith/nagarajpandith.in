...
![Cover Photo of Blog](/blog/p-04/1.png)
...
2. 2PM check-in, 11AM check-out _(Flexible upto '2 hours' early Check-in if no guests the previous day. If more than 2 hrs, then half day’s charge extra.)_
...
2. 12PM check-in, 10AM check-out _(Early check-in is subject to availability and extra charges depends on property owner)_
...
2. 1PM check-in, 11AM check-out _(Early check-in is subject to availability and extra charges depends on property owner)_
...
We took a train ride, had dinner, and played fun games like _Heads Up_ and _Among Us_ before calling it a night. After reaching Pondicherry, we checked in early, freshened up, and had breakfast at **Hotel Manoj**. The day started with a peaceful mangrove boat ride at Will’s Boat House, followed by lunch at **Anthé Restaurant** and some yummy ice cream at **GMT**. We explored **Rock Beach**, the colorful **French Colony**, and the **Craft Bazaar**, ending the evening with snacks by the beach and a visit to the **Gandhi Statue**. Dinner was at **Taka Pizza**, and we wrapped up the day playing games like _Mafia_ and _UNO_.
...
<table>
    ...
    <tr>
        <td>Breakfast - D1 (Average)</td>
        <td>₹ 100</td>
    </tr>
    <tr>
        <td>Breakfast - D2 (Average)</td>
        <td>₹ 80</td>
    </tr>
    <tr>
        <td>Lunch - D1 (Average)</td>
        <td>₹ 300</td>
    </tr>
    <tr>
        <td>Lunch - D2 (Average)</td>
        <td>₹ 300</td>
    </tr>
    <tr>
        <td>Dinner - D1 (Average)</td>
        <td>₹ 320</td>
    </tr>
    <tr>
        <td>Mangrove Motorboating</td>
        <td>₹ 400</td>
    </tr>
    <tr>
        <td>Museum Entry, Science Center Entry, Beach parking</td>
        <td>₹ 50</td>
    </tr>
    <tr>
        <td>Baggage Locker - 11hrs</td>
        <td>₹ 60</td>
    </tr>
    <tr>
        <td>Personal Expenses (Average)*</td>
        <td>₹ 400</td>
    </tr>
    <tr>
        <td>**Approx**</td>
